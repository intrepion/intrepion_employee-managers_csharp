...
namespace Sco.SarTool.AcceptanceTests.Admin;
...
public partial class ApplicationRoleAdminPages : PageTest
{
    ...
    public async Task SetUp()
    {
        ...
        await Page.GetByTestId("loginEmail").FillAsync("Admin1@Sco.SarTool.com");
        await Page.GetByTestId("loginPassword").FillAsync("Admin1@Sco.SarTool.com");
